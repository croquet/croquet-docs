...
~~~~~~~~ HTML
  &lt;script type="text/javascript" charset="UTF-8" src="croquet/croquet-latest.min.js"&gt;&lt;/script&gt;
~~~~~~~~
This loads the Croquet library copied into the `croquet` directory. Alternatively, you can load a stable version of Croquet from `https://unpkg.com/@croquet/croquet@0.5.0`.
